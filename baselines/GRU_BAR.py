...
class GRUnetwork:
    def __init__(self, emb_size, learning_rate, item_num, state_size):
        ...
        self.next_behavior_emb = tf.nn.embedding_lookup(self.all_embeddings['behavior_embeddings'],
                                                        self.next_behaviors_input)
        ...
        self.att_input = tf.concat(
            [self.mix_input, self.mix_input - self.att_behavior_input, self.mix_input * self.att_behavior_input,
             self.att_behavior_input], axis=2)
        ...
        self.output = tf.contrib.layers.fully_connected(self.final_feat, self.item_num, activation_fn=tf.nn.softmax,
                                                        scope='fc')
...
if __name__ == '__main__':
    ...
    save_dir = './model/Tmall/newGRU_BAR/tag_{}_param_{}_{}'.format(args.tag, label, nowTime)
    ...
    with tf.Session() as sess:
        ...
        for i in range(args.epoch):
            ...
            hit5, ndcg5, hit10, ndcg10, hit20, ndcg20 = evaluate_BAR(sess, GRUnet, data_directory, topk,
                                                                     have_dropout=True, is_test=False)
    ...
    # with tf.Session() as sess :
    #     # saver.restore(sess, "./model/JD/newGRU_BAR/2/tag_4_param_0.4_20240923_221852/epoch_19_hit@5_0.3053_ndcg@5_0.2186_hit@10_0.3805_ndcg@10_0.2430_hit@20_0.4581_ndcg@20_0.2627/gru4rec.ckpt")
    #     saver.restore(sess, "./model/Tmall/newGRU_BAR/tag_2_param_0.2_20241210_024143/epoch_8_hit@5_0.0509_ndcg@5_0.0323_hit@10_0.0739_ndcg@10_0.0398_hit@20_0.1074_ndcg@20_0.0482/gru4rec.ckpt")
    #
