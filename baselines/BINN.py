...
if __name__ == '__main__':
    ...
    save_dir = './model/JD/newBINN/tag_{}_param_{}_{}'.format(args.tag, label, nowTime)
    ...
    #
    #     saver.restore(sess, './epoch_40_hit@5_0.2426_ndcg@5_0.1588_hit@10_0.3296_ndcg@10_0.1870_hit@20_0.4054_ndcg@20_0.2062/binn.ckpt')
