...
if __name__ == '__main__':
    ...
    save_dir = './model/JD/newRLBL/tag_{}_param_{}_{}'.format(args.tag, label, nowTime)
    ...
    with tf.Session() as sess:
        ...
        for i in range(args.epoch):
            ...
            #     print("Shape: ", v.shape)
            #     print(v)
            hit5, ndcg5, hit10, ndcg10, hit20, ndcg20 = evaluate_RLBL(sess, RLBLnet, data_directory, topk, have_dropout=True, is_test=False, have_user_emb=True)
    ...
    #     saver.restore(sess,
    #                   "./epoch_31_hit@5_0.1479_ndcg@5_0.0813_hit@10_0.2603_ndcg@10_0.1177_hit@20_0.3619_ndcg@20_0.1436/RLBL.ckpt")
    #
